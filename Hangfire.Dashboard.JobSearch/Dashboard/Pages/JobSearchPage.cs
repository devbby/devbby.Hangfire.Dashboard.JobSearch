...
namespace Hangfire.Dashboard.JobSearch.Dashboard.Pages
{
    public class JobSearchPage : RazorPage
    {
        ...
        {
            using var stream = typeof(JobSearchPage).Assembly.GetManifestResourceStream("Hangfire.Dashboard.JobSearch.Dashboard.Pages.JobSearchPage.html");
